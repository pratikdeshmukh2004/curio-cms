...
`}
      ...
      <div className="mb-32 flex lg:flex-row flex-col justify-between gap-5 text-center w-full lg:max-w-xl lg:w-full lg:mb-0  lg:text-left">
        <Link href={"/diagrams"} className="border-2 border-gray-500 text-gray-300 p-5 rounded-xl font-bold hover:border-sky-700 hover:text-sky-700 cursor-pointer">
          View Diagrams
          <FontAwesomeIcon className="ml-2 text-xs" icon={faDiagramProject} />
        </Link>
        <Link href={"/pointers"} className="border-2 border-gray-500 text-gray-300 p-5 rounded-xl font-bold hover:border-sky-700 hover:text-sky-700 cursor-pointer">
          View Pointers
